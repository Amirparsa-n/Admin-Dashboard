...
const Chat = () => {
  ...
  return (
    <div className='nav-item transition-all navbarItem absolute md:right-48 top-12 bg-white dark:bg-[#42464D] p-8 rounded-lg w-80 md:w-96 shadow-2xl'>
      <div>

        <div className='flex justify-between items-center'>
          <div className='flex gap-x-3'>
            <p className='dark:text-white'>Messages</p>
